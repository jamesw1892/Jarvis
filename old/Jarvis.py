...
def main(os, speak, listen, speaker=None, listener=None):
    ...
    #dealing with listen and speak differently. Despite being longer, this is faster as it only checks the variables 'speak' and 'listen' once at the start rather than every time in the loop.
