...
class Speaker:
    ...
    def speak(self, msg):
        """
        Method to allow Jarvis to speak a msg to the user.
        ~
        PERAMETERS:
...
def init_Jarvis_raspian(speak, listen):
    """
    ...
    if listen:
        from sl4a import Android as AndroidListener
...
if __name__ == "__main__":
    ...
    init_Jarvis_raspian(speak, listen)